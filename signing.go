...
func buildSigningMessage(e Event, prevSigHex string) ([]byte, error) {
...
func signEvent(e Event, prevSigHex string, priv ed25519.PrivateKey) (sigHex, eventHashHex string, err error) {
