...
func TestCodexCumulativeUsageEmitsWithoutFinalResponse(t *testing.T) {
	...
	got := p.Process([]byte(`{"timestamp":"2026-09-14T00:00:01Z","type":"event_msg","payload":{"type":"token_count","info":{"total_token_usage":{"input_tokens":120,"cached_input_tokens":90,"output_tokens":15},"model_context_window":258400}}}`))
